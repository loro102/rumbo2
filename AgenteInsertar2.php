...
if (((${"MM_insert"})=="form1"))
{
  ...
  $MM_editTable="Agentes";
  $MM_editRedirectUrl="Principal.asp";
  $MM_fieldsStr="Nombre|value|NIF|value|Direccion|value|Localidad|value|CP|value|Provincia|value|Telefono1|value|Telefono2|value|Telefono3|value|CCC|value|Comercial|value|Placa|value|Profesion|value|FechaContrato|value";
  $MM_columnsStr="Nombre|',none,''|NIF|',none,''|Direccion|',none,''|Localidad|',none,''|CP|',none,''|Provincia|',none,''|Telefono1|',none,''|Telefono2|',none,''|Telefono3|',none,''|CCC|',none,''|Comercial|',none,''|Placa|none,1,0|Profesion|',none,''|FechaContrato|',none,NULL";
...
<form method="post" action="<? echo $MM_editAction;?>" name="form1">
  <table align="center">
    ...
    <tr valign="baseline">
      ...
      <td><input type="text" name="NIF" value="" size="32">
      </td>
    </tr>
    <tr valign="baseline">
      <td nowrap align="right">Direccion:</td>
      <td><input type="text" name="Direccion" value="" size="32">
      </td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td><input type="text" name="CP" value="" size="32">
      </td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td><input type="text" name="Telefono1" value="" size="32">
      </td>
    </tr>
    <tr valign="baseline">
      <td nowrap align="right">Telefono2:</td>
      <td><input type="text" name="Telefono2" value="" size="32">
      </td>
    </tr>
    <tr valign="baseline">
      <td nowrap align="right">Telefono3:</td>
      <td><input type="text" name="Telefono3" value="" size="32">
      </td>
    </tr>
    <tr valign="baseline">
      <td nowrap align="right">CCC:</td>
      <td><input type="text" name="CCC" value="" size="32">
      </td>
    </tr>
    <tr valign="baseline">
      <td nowrap align="right">Comercial:</td>
      <td><input type="text" name="Comercial" value="" size="32">
      </td>
    </tr>
    <tr valign="baseline">
      <td nowrap align="right">Placa:</td>
      <td><input type="checkbox" name="Placa" value=1 >
      </td>
    </tr>
    <tr valign="baseline">
      <td nowrap align="right">Profesion:</td>
      <td><input type="text" name="Profesion" value="" size="32">
      </td>
    </tr>
    <tr valign="baseline">
      <td nowrap align="right">FechaContrato:</td>
      <td><input type="text" name="FechaContrato" value="" size="32">
      </td>
    </tr>
    <tr valign="baseline">
