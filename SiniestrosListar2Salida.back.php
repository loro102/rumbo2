...
// if (Request.form("CiaContraria")<>"") then Siniestros.Source = Siniestros.Source + " and (Contrarios.Compañia like '"" + Replace(Request.form("CiaContraria"), "'", "''") + "'') and (Contrarios.Siniestro=Siniestro.Id)"
...
?>
<? 
$tracia__MMColParam=(->$Item["Tramitador"]->$Value);
if ((${"MM_EmptyValue"}!=""))
{

  $tracia__MMColParam=${"MM_EmptyValue"};
} 

?>
<? 

// $tracia_cmd is of type "ADODB.Command"
$tracia_cmd_ActiveConnection=$MM_connrumbo_STRING;
$tracia_cmd_CommandText="SELECT * FROM Tramitadorcia WHERE Id = ?";
$tracia_cmd_Prepared=true;
$tracia_cmd_Parameters=$Append$tracia_cmd_CreateParameter="param1"$tracia__MMColParam); // adDouble

$tracia=$tracia_cmd_Execute=$tracia_numRows=0;;
?>
...
?>
  <tr <?     if (($Item["Fase"]$Value==7))
    ...
    {
?><br>
      <font size="-4">reprensando a <?       echo (->$Item["NombreRepresentado"]->$Value);?></font>
    <?     } ?></td>
