...
if ((isset($_GET['Id'])) && ($_GET['Id'] != "")) {
  $deleteSQL = sprintf("DELETE FROM alertas WHERE Id=%s",
                       GetSQLValueString($_GET['Id'], "int"));

  mysql_select_db($database_connrumbo, $connrumbo);
  $Result1 = mysql_query($deleteSQL, $connrumbo) or die(mysql_error());

  $deleteGoTo = "PrincipalCitas.php";
...
header("Location: "."PrincipalCitas.asp");
?>
