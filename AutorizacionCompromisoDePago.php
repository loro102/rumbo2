...
?>
<? 
$aseguradora__MMColParam=->$Item["Compañia"]->$Value;
if ((${"MM_EmptyValue"}!=""))
{
...
if (!($Item["Compañia"]$Value==""))
{
  ...
  $a=str_replace("--==CIA==--",$aseguradora->Fields->$Item["aseguradora"]->$Value,$a);
  $a=str_replace("--==CIADIRECCION==--",$aseguradora->Fields->$Item["direccion"]->$Value,$a);
  $a=str_replace("--==CIALOCALIDAD==--",$aseguradora->Fields->$Item["localidad"]->$Value,$a);
  $a=str_replace("--==CIAPROVINCIA==--",$aseguradora->Fields->$Item["provincia"]->$Value,$a);
  $a=str_replace("--==CIACP==--",$aseguradora->Fields->$Item["cp"]->$Value,$a);
