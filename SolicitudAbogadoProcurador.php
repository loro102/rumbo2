...
<form name="form1" method="post" action="SolicitudAbogadoProcuradorSalida.php">
  <p>Lugar: 
    <input name="Lugar" type="text" id="Lugar" value="Le&oacute;n">
    Fecha:
    <input name="Fecha" type="text" id="Fecha" value="<? echo time()();?>">
    <input name="Siniestro" type="hidden" id="Siniestro" value="<? echo (->$Item["Id"]->$Value);?>">
  </p>
...
Matricula:
<input name="Matricula" type="text" id="Matricula" value="<? echo (->$Item["Matricula"]->$Value);?>">
  </p>
  <p>Abogado:</p>
  <p>Nombre: 
