...
$a=str_replace("--==NIFREPRESENTADO==--",(->$Item["DNIRepresentado"]->$Value),$a);
...
//window.open('<?   echo $Ruta_red.(->$Item["Id"]->$Value)."/Contrato de prestacion de servicios representado.rtf";?>');
